...
begin:/\bhex'(([0-9a-fA-F]{2}_?)*[0-9a-fA-F]{2})?'/},r={className:"string",
begin:/\bhex"(([0-9a-fA-F]{2}_?)*[0-9a-fA-F]{2})?"/};function t(e){
...
var a=t(e),o=l(e),c=/[A-Za-z_$][A-Za-z_$0-9.]*/,d=e.inherit(e.TITLE_MODE,{
...
contains:[a,o,i,r,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,s,_,{
...
solAposStringMode:t,solQuoteStringMode:l,HEX_APOS_STRING_MODE:i,
HEX_QUOTE_STRING_MODE:r,SOL_NUMBER:s,isNegativeLookbehindAvailable:e}
...
;var r=n.map((e=>8*e)),t=[];for(i=0;i<=80;i++)t[i]=i
;var l=n.map((e=>"bytes"+e)).join(" ")+" ",o=r.map((e=>"uint"+e)).join(" ")+" ",E=r.map((e=>"int"+e)).join(" ")+" ",p=[].concat.apply([],r.map((e=>t.map((a=>e+"x"+a))))),M={
keyword:"var bool string int uint "+E+o+"byte bytes "+l+"fixed ufixed "+p.map((e=>"fixed"+e)).join(" ")+" "+p.map((e=>"ufixed"+e)).join(" ")+" enum struct mapping address new delete if else for while continue break return throw emit try catch revert unchecked _ function modifier event constructor fallback receive error virtual override constant immutable anonymous indexed storage memory calldata external public internal payable pure view private returns import from as using global pragma contract interface library is abstract type assembly",
...
lexemes:C,keywords:M}),w={className:"built_in",
