...
export default function BasicWallet() {
  ...
  useEffect(() => {
    if (address) {
      fetchERC20Balances("0xd26C04bE22Cb25c7727504daF4304919cA26e301").then(
        setErc20Balances
      );
      fetchERC721Balances("0xd26C04bE22Cb25c7727504daF4304919cA26e301").then(
        setErc721Balances
      );
      fetchERC1155Balances("0xd26C04bE22Cb25c7727504daF4304919cA26e301").then(
        setErc1155Balances
      );
      fetchRecentTransactions(
        "0xd26C04bE22Cb25c7727504daF4304919cA26e301"
                  ...
                  <li key={tx.logIndex} className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="text-xs text-white">
                        {String(tx.from?.address) ===
                        "0xd26C04bE22Cb25c7727504daF4304919cA26e301"
                          ? "Send"
                          : String(tx.to?.address) ===
                            "0xd26C04bE22Cb25c7727504daF4304919cA26e301"
                          ? "Receive"
                          : "SW"}
                      </p>
