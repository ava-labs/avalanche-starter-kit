...
export default function Home() {
  return (
    <Web3Provider
      ...
      chains={CHAINS}
    >
      <div className="grid grid-cols-12 text-white text-sm items-center bg-gradient-to-b from-[#1BE866] via-[#8DF3B2] to-[#8DF3B2]">
        {/* ICTT Example */}
        <div className="col-span-12 flows-bg w-full h-screen">
          <div className="flex flex-col w-full h-full justify-center items-center gap-4">
            ...
            ></ICTT>
            <a
              className="flex items-center gap-2 text-[#364655] hover:underline"
              href="https://academy.avax.network/course/interchain-token-transfer"
              target="_blank"
            >
              <Info size={16} />
              <p className="text-xs text-[#364655]">What is ICTT?</p>
            </a>
            <a
              className="w-[120px]"
