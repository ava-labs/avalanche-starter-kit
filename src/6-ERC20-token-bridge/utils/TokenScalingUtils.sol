...
library TokenScalingUtils {
     ...
     */
    function applyTokenScale(uint256 tokenMultiplier, bool multiplyOnDestination, uint256 sourceTokenAmount)
        internal
        pure
        returns (uint256)
    {
     ...
     */
    function removeTokenScale(uint256 tokenMultiplier, bool multiplyOnDestination, uint256 destinationTokenAmount)
        internal
        pure
        returns (uint256)
    {
     ...
     */
    function _scaleTokens(uint256 tokenMultiplier, bool multiplyOnDestination, uint256 amount, bool isSendToDestination)
        private
        pure
        returns (uint256)
    {
